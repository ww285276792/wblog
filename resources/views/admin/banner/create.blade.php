        ...
        <div class="ui stackable two column grid">
            <div class="column">
                ...
                <div class="ui breadcrumb">
                    ...
                    <i class="right chevron icon divider"></i>
                    <div class="active section">{{trans('banner.add_banner')}}</div>
                </div>
            </div>
        </div>
        <div class="ui hidden divider"></div>
        <div class="ui segment">
            <form method="post" action="{{route('admin_setting_banner.store')}}" class="ui loadable form"
                ...
                <div class="field">
                    ...
                    <input type="text" name="sort" value="{{old('sort')?old('sort'):1}}"
                ...
                <div class="field">
                    ...
                    <div class="inline field">
                        <div class="ui toggle checkbox">
                            <input type="checkbox" tabindex="0" name="visible" value="1" class="hidden">
                        </div>
                    </div>
